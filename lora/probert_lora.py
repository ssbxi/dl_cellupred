...
def load_esm2_model(shorthand, quantized=True):
    model_versions = {
        ...
        "650m":"/db/esm-2/650m",
        "3B": "/db/esm-2/3B",
        "1b650m":"/db/esm-1/esm-1b",
        "prot_bert":"/db/prot_bert",
        "prot_bert_bfd":"/db/prot_bert_bfd"
    }
    ...
    if shorthand.startswith("prot_bert"):
        model_class = AutoModelForSequenceClassification
    else:
        model_class = EsmForSequenceClassification

    if quantized and not shorthand.startswith("prot_bert"):
